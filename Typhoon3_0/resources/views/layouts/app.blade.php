...
<body onload="loadPage()">
    ...
    <div class="menu_container">
        <div class="menu_inner_container">
            <nav class="menu_nav">
                <a id="str_gl" class="link_nav" href="/">STRONA GLÓWNA</a>
            ...
            @guest
                    <nav class="menu_nav_icons">
                        ...
                        @endif
                        <a href="{{route('cartIndex')}}"><img style="height: 25px;" src="../images/cart.png"><span class="badge badge-pill badge-danger">{{ count((array) session('cart')) }}</span></a>
