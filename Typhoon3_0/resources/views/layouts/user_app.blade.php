...
<body onload="loadPage()">
    ...
    <div class="menu_container">
        <div class="menu_inner_container">
            <nav class="menu_nav">
                <a id="str_gl" class="link_nav" href="{{route('userHome')}}">STRONA GLÓWNA</a>
                <a class="link_nav" href="{{route('userMenu')}}">MENU</a>
                <a class="link_nav" href="{{route('userOrders')}}">ZAMÓWIENIE</a>
                <a class="link_nav" href="{{route('userContact')}}">KONTAKT</a>
            </nav>
            @guest
                    <nav class="menu_nav_icons">
                        ...
                        @else
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" style="margin-left: 35%; margin-top: 1%" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}

                                </a>
                                <a href="{{route('cartIndexUser')}}"><img style="height: 25px; margin-top: 50%;" src="../../images/cart.png"></a>
