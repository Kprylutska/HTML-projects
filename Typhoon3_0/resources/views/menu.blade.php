...
<div style="height: 500px; width: 300px; background-color: #1d2528; margin: 25px 10px 25px">
    ...
    <form action="{{route('showDishes', $dish->id)}}">
    ...
    <!-- <div style="display:block; margin-left:auto; margin-right:auto; margin-top:20px; width: 200px"><a href="{{route('showDishes', $dish->id)}}">Details</a></div> -->
</div>
@endforeach 
@endsection
